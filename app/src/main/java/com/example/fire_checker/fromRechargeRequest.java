...
public class fromRechargeRequest extends AsyncTask<Void, Void, Void> {
    final int[] res = new int[1];
    final int[] check = new int[1];
    String value ="";
    Activity this_act;

    public fromRechargeRequest(Activity context){
        this_act = context;
    }
    ...
    protected Void doInBackground(Void... voids) {
        ...
        try{
            set_status_endpoint = new URL("http://194.67.55.58:8080/api/fromRecharge");
            try {
